...
def trigger_finalize(
    ...
    # The project-level gate is the mutual-exclusion lock: only one run of a
    # project computes at a time, whichever run that is. It stays exactly as it
    # was, which is what keeps a finalize of run 2 from starting while run 4 is
    # still analysing.
    #
